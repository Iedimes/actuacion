                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'nombre'">{{ trans('admin.customer.columns.nombre') }}</th>
                                        <th is='sortable' :column="'ci'">{{ trans('admin.customer.columns.ci') }}</th>
                                        <th is='sortable' :column="'domicilio'">{{ trans('admin.customer.columns.domicilio') }}</th>
                                        <th is='sortable' :column="'monto'">{{ trans('admin.customer.columns.monto') }}</th>
                                        <th is='sortable' :column="'gasto'">{{ trans('admin.customer.columns.gasto') }}</th>
                                        <th is='sortable' :column="'vto'">{{ trans('admin.customer.columns.vto') }}</th>
