...
class FillPermissionsForCustumer extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCustumer constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.custumer',
            'admin.custumer.index',
            'admin.custumer.create',
            'admin.custumer.show',
            'admin.custumer.edit',
            'admin.custumer.delete',
            'admin.custumer.bulk-delete',
        ]);
