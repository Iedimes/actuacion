...
class FillPermissionsForImpression extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForImpression constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.impression',
            'admin.impression.index',
            'admin.impression.create',
            'admin.impression.show',
            'admin.impression.edit',
            'admin.impression.delete',
            'admin.impression.bulk-delete',
        ]);
